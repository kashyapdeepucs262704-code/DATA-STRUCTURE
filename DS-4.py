...
def display_menu():
    ...
    print("4. " + Fore.BLUE + "Delete at beginning")
    print("5. " + Fore.BLUE + "Delete at end")
    print("6. " + Fore.BLUE + "Delete at position")
    ...
    while True:
        ...
        try:
            ...
            if choice == 1:
                ...
                linked_list.delete_node_at_position(
                    position
                )
                ...
                length = linked_list.length_of_list()
